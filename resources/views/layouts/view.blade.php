...
<base href="../../../" />
		...
		<link rel="canonical" href="http://preview.keenthemes.comapps/user-management/users/view.html" />
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link active" href="http://127.0.0.1:8000/admin/users/{{ $user->id }}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_673c0c8e9c5e4">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_673c0c8e9c5e4" data-allow-clear="true">
																<option></option>
												...
												<div class="card-body">
													...
													<div id="kt_user_view_details" class="collapse show">
														<div class="pb-5 fs-6">
															...
															<div class="text-gray-600">20 Dec 2024, 5:30 pm</div>
															<!--begin::Details item-->
														</div>
													</div>
													<!--end::Details content-->
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/customer/c_673c0c8e9db71/not_found</td>
																			<td class="pe-0 text-end min-w-200px">19 Aug 2024, 9:23 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_3829_3738/invalid</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/customer/c_673c0c8e9db71/not_found</td>
																			<td class="pe-0 text-end min-w-200px">22 Sep 2024, 6:43 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_9718_2463/payment</td>
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	...
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2024, 11:05 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																	...
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">10 Nov 2024, 11:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice 
																	...
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2024, 2:40 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Max Smith</a>has made payment to 
																		<a href="#" class="fw-bold text-gray-900 text-hover-primary">#SDK-45670</a></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2024, 11:05 am</td>
																	</tr>
																</tbody>
															</table>
															<!--end::Table-->
